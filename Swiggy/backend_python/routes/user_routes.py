...
from models.user_model import User, UserLogin, UserResponse, user_helper
...
async def register_user(user: User):
    try:
        ...
        response = ApiResponse(201, {"token": token, "role": created_user["role"]}, "Registration successful")
...
async def login_user(user_login: UserLogin):
    try:
        ...
        response = ApiResponse(200, {"token": token, "role": user["role"]}, "Login successful")
